...
# @IMPROVE -- I am not sure that the memoisation
# can be accessed in parallel computations
# ATTENTION, I am not sure of what will be the memory imprint
# of storing all these values
##################################################
